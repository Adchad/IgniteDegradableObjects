...
We will begin by going in depth into the issue we are trying to solve, regarding contention and scalability in parrallel and distributed software.

We will then explain in detail the theory behind degradable objects and how they can be implemented.

We next will detail the information we gathered by analysing Apache Ignite.

Finally, we will show the result obtained.
